...
elseif(vowel=='E')
    F =  [538, 1842, 2511 3248]; % Formant frequencies (Hz)
elseif(vowel=='i')
    F =  [258, 2210, 2875 3126]; % Formant frequencies (Hz)
elseif(vowel=='O')
    F =  [504, 910, 2609 3146]; % Formant frequencies (Hz)
elseif(vowel=='u')
    F =  [277, 627, 2443 3102]; % Formant frequencies (Hz)
...
figure(2),freqz(B,A); % View frequency response:
...
soundsc([sig,sig,speech,speech]); % hear buzz, then 'ah'